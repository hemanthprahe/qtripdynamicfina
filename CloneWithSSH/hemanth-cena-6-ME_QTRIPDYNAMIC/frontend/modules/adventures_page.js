...
// function filterFunction(list, filters) {
  function filterFunction(adventure,filters) {
  // TODO: MODULE_FILTERS
  ...
  if(filters["duration"].length>0 && filters["category"].length>0){
    ...
    filteredList = filterByDuration(adventure,parseInt(choice[0]),parseInt(choice[1]));
    ...
    filteredList = filterByCategory(adventure,filters["category"])
  }
  else{
    filteredList = adventure
  }
